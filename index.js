...
var PLAID_CLIENT_ID = envvar.string('PLAID_CLIENT_ID','5e368e5955ca3700155f919a');
var PLAID_SECRET = envvar.string('PLAID_SECRET','9b5a45c7ce774bd6ca61ea11adb8e6');
var PLAID_PUBLIC_KEY = envvar.string('PLAID_PUBLIC_KEY','bb9516d5f3d880f1571c54b2599eca');
...
app.post('/get_access_token', function(request, response, next) {
  ...
  console.log("req and response",request.body.public_token)
